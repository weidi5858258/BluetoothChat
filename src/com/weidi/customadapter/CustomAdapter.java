 ...
 */
public abstract class CustomAdapter<T> extends CustomListViewAdapter<T> implements CRUD<T> {
     ...
     */
    public CustomAdapter(Context context, List<T> items, int layoutResId) {
     ...
     */
    public CustomAdapter(Context context, List<T> items, IMultiItemViewType<T> mulItemViewType) {
