...
package com.weidi.bluetoothchat.settings;
...
import com.weidi.bluetoothchat.settings.profile.A2dpProfile;
import com.weidi.bluetoothchat.settings.profile.HeadsetProfile;
import com.weidi.bluetoothchat.settings.profile.HidProfile;
import com.weidi.bluetoothchat.settings.profile.LocalBluetoothProfile;
import com.weidi.bluetoothchat.settings.profile.OppProfile;
import com.weidi.bluetoothchat.settings.profile.PanProfile;
import com.weidi.bluetoothchat.settings.profile.PbapServerProfile;
...
public final class LocalBluetoothProfileManager {
    ...
    private HeadsetProfile mHeadsetProfile;// int HEADSET = 1
    private A2dpProfile mA2dpProfile;// int A2DP = 2
    private OppProfile mOppProfile;// int HEALTH = 3
    private final HidProfile mHidProfile;// int INPUT_DEVICE = 4
    private final PanProfile mPanProfile;// int PAN = 5
    private final PbapServerProfile mPbapProfile;// int PBAP = 6
     ...
     * @param uuids
     */
    private void updateLocalProfiles(ParcelUuid[] uuids) {
        // A2DP
