...
/**
 * 只是进一步封闭了BluetoothAdapter而已,是个单例
 * <p>
 ...
 * <p>
 * Connection and bonding state changes affecting specific devices are handled by
 * {@link CachedBluetoothDeviceManager},
 * {@link BluetoothEventManager},
...
public final class LocalBluetoothAdapter {
    ...
    public void setBluetoothEnabled(boolean enabled) {
        ...
        if (success) {
            setBluetoothStateInt(enabled
                    ...
                    : BluetoothAdapter.STATE_TURNING_OFF);// go into
        } else {
            if (Utils.V) {
    ...
    private boolean syncBluetoothState() {
