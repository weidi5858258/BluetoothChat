...
package com.weidi.bluetoothchat.settings.profile;
...
public interface LocalBluetoothProfile {
     ...
     */
    int getNameResource(BluetoothDevice device);// String id
     ...
     */
    int getSummaryResourceForDevice(BluetoothDevice device);// summary id

    int getDrawableResource(BluetoothClass btClass);// drawable id
}
